...
*/
// tyrannosaurus, carnivorous, 7000kg, 12m, Late Cretaceous <- So this would be object 1

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic <- So this would be object 2

// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous <- So this would be object 3
...
graduates.map(graduate => universities.push(graduate.university))
...
const lowPopulationAnimals = zooAnimals.filter(lowPopAnimal => lowPopAnimal.population < 5);
...
const populationTotal = zooAnimals.reduce((populationTotal, populationAmount) => {
